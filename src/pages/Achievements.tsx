...
import { 
  Trophy as TrophyIcon, Star as StarIcon, Target as TargetIcon, 
  Clock as ClockIcon, Calendar as CalendarIcon, 
  TrendingUp as TrendingUpIcon, Award as AwardIcon, Crown as CrownIcon, 
  Brain as BrainIcon, Flame as FlameIcon, Flag as FlagIcon, 
  Moon as MoonIcon, Infinity as InfinityIcon, Medal as MedalIcon, 
  Plus as PlusIcon, Check as CheckIcon, X as XIcon,
  History as HistoryIcon, LineChart as LineChartIcon
} from 'lucide-react';
...
const Achievements = () => {
  ...
  const tabs = [
    { id: 'goals', label: t('achievements.tabs.goals'), icon: TrophyIcon },
    { id: 'badges', label: t('achievements.tabs.badges'), icon: MedalIcon },
    { id: 'history', label: t('achievements.tabs.history'), icon: HistoryIcon },
    { id: 'graphs', label: t('achievements.tabs.graphs'), icon: LineChartIcon },
  ];
